! function(e, t) {
	...
	function b(e) {
		var t = J,
			n = Re[e];
		return n || (n = x(e, t), "none" !== n && n || (Pe = (Pe || Z("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement), t = Pe[0].contentDocument, t.write(), t.close(), n = x(e, t), Pe.detach()), Re[e] = n), n
	}

	function w(e, t, n) {
		var i, r, o, a, s = e.style;
		return n = n || Be(e), n && (a = n.getPropertyValue(t) || n[t]), n && ("" !== a || Z.contains(e.ownerDocument, e) || (a = Z.style(e, t)), Ie.test(a) && We.test(t) && (i = s.width, r = s.minWidth, o = s.maxWidth, s.minWidth = s.maxWidth = s.width = a, a = n.width, s.width = i, s.minWidth = r, s.maxWidth = o)), void 0 !== a ? a + "" : a
	}
	...
	function N(e, t, n, i, r) {
		for (var o = n === (i ? "border" : "content") ? 4 : "width" === t ? 1 : 0, a = 0; 4 > o; o += 2) "margin" === n && (a += Z.css(e, n + Ce[o], !0, r)), i ? ("content" === n && (a -= Z.css(e, "padding" + Ce[o], !0, r)), "margin" !== n && (a -= Z.css(e, "border" + Ce[o] + "Width", !0, r))) : (a += Z.css(e, "padding" + Ce[o], !0, r), "padding" !== n && (a += Z.css(e, "border" + Ce[o] + "Width", !0, r)));
		return a
	}
	...
	function D(e, t) {
		for (var n, i, r, o = [], a = 0, s = e.length; s > a; a++) i = e[a], i.style && (o[a] = ve.get(i, "olddisplay"), n = i.style.display, t ? (o[a] || "none" !== n || (i.style.display = ""), "" === i.style.display && Te(i) && (o[a] = ve.access(i, "olddisplay", b(i.nodeName)))) : (r = Te(i), "none" === n && r || ve.set(i, "olddisplay", r ? n : Z.css(i, "display"))));
	...
	function L(e, t, n) {
		...
		if (Z.isEmptyObject(d)) "inline" === ("none" === l ? b(e.nodeName) : l) && (p.display = l);
			...
			for (i in d) a = A(h ? g[i] : 0, i, f), i in g || (g[i] = a.start, h && (a.end = a.start, a.start = "width" === i || "height" === i ? 1 : 0))
		}
	}
	...
	function H(e, t, n) {
		var i, r, o = 0,
			...
			u = function() {
				if (r) return !1;
				for (var t = Qe || j(), n = Math.max(0, l.startTime + l.duration - t), i = n / l.duration || 0, o = 1 - i, a = 0, u = l.tweens.length; u > a; a++) l.tweens[a].run(o);
	...
	function R(e, t, n, i) {
		...
		if (Z.isArray(t)) Z.each(t, function(t, r) {
			n || kt.test(e) ? i(e, r) : R(e + "[" + ("object" == typeof r ? t : "") + "]", r, n, i)
		});
	...
	var re = function(e) {
		function t(e, t, n, i) {
			...
			if (!i && H) {
				...
				if (w.qsa && (!O || !O.test(e))) {
					if (p = f = P, h = t, g = 1 !== s && e, 1 === s && "object" !== t.nodeName.toLowerCase()) {
		...
		function p(e, t, n) {
			...
			return t.first ? function(t, n, o) {
				...
				if (a) {
					...
					for (; t = t[i];)
						if (1 === t.nodeType || r) {
							if (u = t[P] || (t[P] = {}), (s = u[i]) && s[0] === W && s[1] === o) return l[2] = s[2];
			...
			return r && !r[P] && (r = v(r)), o && !o[P] && (o = v(o, a)), i(function(i, a, s, u) {
				...
				if (i) {
					if (o || e) {
						...
						for (c = x.length; c--;)(f = x[c]) && (l = o ? ee(i, f) : d[c]) > -1 && (i[l] = !(a[l] = f))
					}
			...
			var r = n.length > 0,
				...
				a = function(i, a, s, u, l) {
					var c, f, d, p = 0,
						...
						w = x.length;
					for (l && (S = a !== L && a); h !== w && null != (c = x[h]); h++) {
						if (o && c) {
							for (f = 0; d = e[f++];)
								if (d(c, a, s)) {
									u.push(c);
		...
		var b, w, C, T, k, N, E, D, S, j, _, A, L, q, H, O, M, $, F, P = "sizzle" + 1 * new Date,
			R = e.document,
			W = 0,
			I = 0,
			B = n(),
		...
		w = t.support = {}, k = t.isXML = function(e) {
			...
			return i !== L && 9 === i.nodeType && i.documentElement ? (L = i, q = i.documentElement, n = i.defaultView, n && n !== n.top && (n.addEventListener ? n.addEventListener("unload", Te, !1) : n.attachEvent && n.attachEvent("onunload", Te)), H = !k(i), w.attributes = r(function(e) {
				return e.className = "i", !e.getAttribute("className")
			}), w.getElementsByTagName = r(function(e) {
				return e.appendChild(i.createComment("")), !e.getElementsByTagName("*").length
			}), w.getElementsByClassName = ve.test(i.getElementsByClassName), w.getById = r(function(e) {
				return q.appendChild(e).id = P, !i.getElementsByName || !i.getElementsByName(P).length
			...
			}, M = [], O = [], (w.qsa = ve.test(i.querySelectorAll)) && (r(function(e) {
			...
			})), (w.matchesSelector = ve.test($ = q.matches || q.webkitMatchesSelector || q.mozMatchesSelector || q.oMatchesSelector || q.msMatchesSelector)) && r(function(e) {
				w.disconnectedMatch = $.call(e, "div"), $.call(e, "[s!='']:x"), M.push("!=", ae)
			}), O = O.length && new RegExp(O.join("|")), M = M.length && new RegExp(M.join("|")), t = ve.test(q.compareDocumentPosition), F = t || ve.test(q.contains) ? function(e, t) {
				...
				return n ? n : (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n || !w.sortDetached && t.compareDocumentPosition(e) === n ? e === i || e.ownerDocument === R && F(R, e) ? -1 : t === i || t.ownerDocument === R && F(R, t) ? 1 : j ? ee(j, e) - ee(j, t) : 0 : 4 & n ? -1 : 1)
			} : function(e, t) {
				if (e === t) return _ = !0, 0;
				var n, r = 0,
					o = e.parentNode,
			...
			if ((e.ownerDocument || e) !== L && A(e), n = n.replace(fe, "='$1']"), !(!w.matchesSelector || !H || M && M.test(n) || O && O.test(n))) try {
				var i = $.call(e, n);
			...
			var t, n = [],
				i = 0,
				r = 0;
			if (_ = !w.detectDuplicates, j = !w.sortStable && e.slice(0), e.sort(Y), _) {
					...
					return 1 === i && 0 === r ? function(e) {
						...
						if (m) {
							...
							if (h = [a ? m.firstChild : m.lastChild], a && y) {
								for (c = m[P] || (m[P] = {}), l = c[e] || [], p = l[0] === W && l[1], d = l[0] === W && l[2], f = p && m.childNodes[p]; f = ++p && f && f[g] || (d = p = 0) || h.pop();)
									if (1 === f.nodeType && ++d && f === t) {
										c[e] = [W, p, d];
										break
									}
							} else if (y && (l = (t[P] || (t[P] = {}))[e]) && l[0] === W) d = l[1];
							else
								for (;
									(f = ++p && f && f[g] || (d = p = 0) || h.pop()) && ((s ? f.nodeName.toLowerCase() !== v : 1 !== f.nodeType) || !++d || (y && ((f[P] || (f[P] = {}))[e] = [W, d]), f !== t)););
		...
		return f.prototype = C.filters = C.pseudos, C.setFilters = new f, N = t.tokenize = function(e, n) {
			...
			var n, i = [],
				...
				o = z[e + " "];
			if (!o) {
				for (t || (t = N(e)), n = t.length; n--;) o = y(t[n]), o[P] ? i.push(o) : r.push(o);
				o = z(e, x(r, i)), o.selector = e
			}
			return o
		}, D = t.select = function(e, t, n, i) {
			var r, o, a, s, u, l = "function" == typeof e && e,
				f = !i && N(e = l.selector || e);
			if (n = n || [], 1 === f.length) {
				...
				for (r = he.needsContext.test(e) ? 0 : o.length; r-- && (a = o[r], !C.relative[s = a.type]);)
					if ((u = C.find[s]) && (i = u(a.matches[0].replace(we, Ce), xe.test(o[0].type) && c(t.parentNode) || t))) {
						if (o.splice(r, 1), e = i.length && d(o), !e) return K.apply(n, i), n;
						break
					}
			}
			return (l || E(e, f))(i, t, !H, n, xe.test(e) && c(t.parentNode) || t), n
		}, w.sortStable = P.split("").sort(Y).join("") === P, w.detectDuplicates = !! _, A(), w.sortDetached = r(function(e) {
	...
	Z.Callbacks = function(e) {
		...
		when: function(e) {
			var t, n, i, r = 0,
				...
				l = function(e, n, i) {
					return function(r) {
						n[e] = this, i[e] = arguments.length > 1 ? B.call(arguments) : r, i === t ? u.notifyWith(n, i) : --s || u.resolveWith(n, i)
					}
				};
			if (a > 1)
	...
	Z.event = {
		...
		add: function(e, t, n, i, r) {
			...
			if (m)
				for (n.handler && (o = n, n = o.handler, r = o.selector), n.guid || (n.guid = Z.guid++), (u = m.events) || (u = m.events = {}), (a = m.handle) || (a = m.handle = function(t) {
				...
				}), t = (t || "").match(pe) || [""], l = t.length; l--;) s = je.exec(t[l]) || [], p = g = s[1], h = (s[2] || "").split(".").sort(), p && (f = Z.event.special[p] || {}, p = (r ? f.delegateType : f.bindType) || p, f = Z.event.special[p] || {}, c = Z.extend({
					type: p,
					origType: g,
					data: i,
					handler: n,
					...
					namespace: h.join(".")
				}, o), (d = u[p]) || (d = u[p] = [], d.delegateCount = 0, f.setup && f.setup.call(e, i, h, a) !== !1 || e.addEventListener && e.addEventListener(p, a, !1)), f.add && (f.add.call(e, c), c.handler.guid || (c.handler.guid = n.guid)), r ? d.splice(d.delegateCount++, 0, c) : d.push(c), Z.event.global[p] = !0)
		},
		remove: function(e, t, n, i, r) {
			var o, a, s, u, l, c, f, d, p, h, g, m = ve.hasData(e) && ve.get(e);
			if (m && (u = m.events)) {
				for (t = (t || "").match(pe) || [""], l = t.length; l--;)
					if (s = je.exec(t[l]) || [], p = g = s[1], h = (s[2] || "").split(".").sort(), p) {
						for (f = Z.event.special[p] || {}, p = (i ? f.delegateType : f.bindType) || p, d = u[p] || [], s = s[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), a = o = d.length; o--;) c = d[o], !r && g !== c.origType || n && n.guid !== c.guid || s && !s.test(c.namespace) || i && i !== c.selector && ("**" !== i || !c.selector) || (d.splice(o, 1), c.selector && d.delegateCount--, f.remove && f.remove.call(e, c));
						a && !d.length && (f.teardown && f.teardown.call(e, h, m.handle) !== !1 || Z.removeEvent(e, p, m.handle), delete u[p])
					} else
						for (p in u) Z.event.remove(e, p + t[l], n, i, !0);
		...
		trigger: function(t, n, i, r) {
			...
			if (a = s = i = i || J, 3 !== i.nodeType && 8 !== i.nodeType && !Se.test(p + Z.event.triggered) && (p.indexOf(".") >= 0 && (h = p.split("."), p = h.shift(), h.sort()), l = p.indexOf(":") < 0 && "on" + p, t = t[Z.expando] ? t : new Z.Event(p, "object" == typeof t && t), t.isTrigger = r ? 2 : 3, t.namespace = h.join("."), t.namespace_re = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), n = null == n ? [t] : Z.makeArray(n, [t]), f = Z.event.special[p] || {}, r || !f.trigger || f.trigger.apply(i, n) !== !1)) {
				...
				for (o = 0;
					 (a = d[o++]) && !t.isPropagationStopped();) t.type = o > 1 ? u : f.bindType || p, c = (ve.get(a, "events") || {})[t.type] && ve.get(a, "handle"), c && c.apply(a, n), c = l && a[l], c && c.apply && Z.acceptData(a) && (t.result = c.apply(a, n), t.result === !1 && t.preventDefault());
				return t.type = p, r || t.isDefaultPrevented() || f._default && f._default.apply(d.pop(), n) !== !1 || !Z.acceptData(i) || l && Z.isFunction(i[p]) && !Z.isWindow(i) && (s = i[l], s && (i[l] = null), Z.event.triggered = p, i[p](), Z.event.triggered = void 0, s && (i[l] = s)), t.result
			}
		},
		dispatch: function(e) {
			e = Z.event.fix(e);
		...
		fix: function(e) {
			...
			var t, n, i, r = e.type,
				o = e,
				a = this.fixHooks[r];
			for (a || (this.fixHooks[r] = a = De.test(r) ? this.mouseHooks : Ee.test(r) ? this.keyHooks : {}), i = a.props ? this.props.concat(a.props) : this.props, e = new Z.Event(o), t = i.length; t--;) n = i[t], e[n] = o[n];
	...
	Fe.optgroup = Fe.option, Fe.tbody = Fe.tfoot = Fe.colgroup = Fe.caption = Fe.thead, Fe.th = Fe.td, Z.extend({
		...
		buildFragment: function(e, t, n, i) {
			for (var r, o, a, s, u, l, c = t.createDocumentFragment(), f = [], d = 0, p = e.length; p > d; d++)
				if (r = e[d], r || 0 === r)
					if ("object" === Z.type(r)) Z.merge(f, r.nodeType ? [r] : r);
					else if (Le.test(r)) {
						for (o = o || c.appendChild(t.createElement("div")), a = (Ae.exec(r) || ["", ""])[1].toLowerCase(), s = Fe[a] || Fe._default, o.innerHTML = s[1] + r.replace(_e, "<$1></$2>") + s[2], l = s[0]; l--;) o = o.lastChild;
		...
		html: function(e) {
			return me(this, function(e) {
				...
				if ("string" == typeof e && !qe.test(e) && !Fe[(Ae.exec(e) || ["", ""])[1].toLowerCase()]) {
					e = e.replace(_e, "<$1></$2>");
					try {
		...
		domManip: function(e, t) {
			...
			var n, i, r, o, a, s, u = 0,
				...
				d = e[0],
				g = Z.isFunction(d);
			if (g || l > 1 && "string" == typeof d && !Q.checkClone && He.test(d)) return this.each(function(n) {
				var i = c.eq(n);
			...
			if (l && (n = Z.buildFragment(e, this[0].ownerDocument, !1, this), i = n.firstChild, 1 === n.childNodes.length && (n = i), i)) {
				for (r = Z.map(v(n, "script"), p), o = r.length; l > u; u++) a = n, u !== f && (a = Z.clone(a, !0, !0), o && Z.merge(r, v(a, "script"))), t.call(this[u], a, u);
				if (o)
					for (s = r[r.length - 1].ownerDocument, Z.map(r, h), u = 0; o > u; u++) a = r[u], Oe.test(a.type || "") && !ve.access(a, "globalEval") && Z.contains(s, a) && (a.src ? Z._evalUrl && Z._evalUrl(a.src) : Z.globalEval(a.textContent.replace($e, "")))
			}
			return this
		}
	}), Z.each({
		...
		style: function(e, t, n, i) {
			if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
				var r, o, a, s = Z.camelCase(t),
					u = e.style;
				return t = Z.cssProps[s] || (Z.cssProps[s] = T(u, s)), a = Z.cssHooks[t] || Z.cssHooks[s], void 0 === n ? a && "get" in a && void 0 !== (r = a.get(e, !1, i)) ? r : u[t] : (o = typeof n, "string" === o && (r = Ye.exec(n)) && (n = (r[1] + 1) * r[2] + parseFloat(Z.css(e, t)), o = "number"), void(null != n && n === n && ("number" !== o || Z.cssNumber[s] || (n += "px"), Q.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (u[t] = "inherit"), a && "set" in a && void 0 === (n = a.set(e, n, i)) || (u[t] = n))))
			}
		},
		css: function(e, t, n, i) {
			var r, o, a, s = Z.camelCase(t);
			return t = Z.cssProps[s] || (Z.cssProps[s] = T(e.style, s)), a = Z.cssHooks[t] || Z.cssHooks[s], a && "get" in a && (r = a.get(e, !0, n)), void 0 === r && (r = w(e, t, i)), "normal" === r && t in Ve && (r = Ve[t]), "" === n || n ? (o = parseFloat(r), n === !0 || Z.isNumeric(o) ? o || 0 : r) : r
		}
	}), Z.each(["height", "width"], function(e, t) {
		Z.cssHooks[t] = {
			get: function(e, n, i) {
				return n ? Xe.test(Z.css(e, "display")) && 0 === e.offsetWidth ? Z.swap(e, Ue, function() {
					return E(e, t, i)
				}) : E(e, t, i) : void 0
			},
			set: function(e, n, i) {
				var r = i && Be(e);
				return k(e, n, i ? N(e, t, i, "border-box" === Z.css(e, "boxSizing", !1, r), r) : 0)
			}
		}
	...
	Z.fn.extend({
		...
		attr: function(e, t, n) {
			...
			return e && 3 !== o && 8 !== o && 2 !== o ? typeof e.getAttribute === Ne ? Z.prop(e, t, n) : (1 === o && Z.isXMLDoc(e) || (t = t.toLowerCase(), i = Z.attrHooks[t] || (Z.expr.match.bool.test(t) ? rt : it)), void 0 === n ? i && "get" in i && null !== (r = i.get(e, t)) ? r : (r = Z.find.attr(e, t), null == r ? void 0 : r) : null !== n ? i && "set" in i && void 0 !== (r = i.set(e, n, t)) ? r : (e.setAttribute(t, n + ""), n) : void Z.removeAttr(e, t)) : void 0
		},
	...
	Z.extend({
		...
		ajax: function(e, t) {
			...
			if (h.promise(w).complete = g.add, w.success = w.done, w.error = w.fail, f.url = ((e || f.url || wt) + "").replace(ft, "").replace(mt, Ct[1] + "//"), f.type = t.method || t.type || f.method || f.type, f.dataTypes = Z.trim(f.dataType || "*").toLowerCase().match(pe) || [""], null == f.crossDomain && (u = vt.exec(f.url.toLowerCase()), f.crossDomain = !(!u || u[1] === Ct[1] && u[2] === Ct[2] && (u[3] || ("http:" === u[1] ? "80" : "443")) === (Ct[3] || ("http:" === Ct[1] ? "80" : "443")))), f.data && f.processData && "string" != typeof f.data && (f.data = Z.param(f.data, f.traditional)), M(yt, f, t, w), 2 === x) return w;
			l = Z.event && f.global, l && 0 === Z.active++ && Z.event.trigger("ajaxStart"), f.type = f.type.toUpperCase(), f.hasContent = !gt.test(f.type), r = f.url, f.hasContent || (f.data && (r = f.url += (ct.test(r) ? "&" : "?") + f.data, delete f.data), f.cache === !1 && (f.url = dt.test(r) ? r.replace(dt, "$1_=" + lt++) : r + (ct.test(r) ? "&" : "?") + "_=" + lt++)), f.ifModified && (Z.lastModified[r] && w.setRequestHeader("If-Modified-Since", Z.lastModified[r]), Z.etag[r] && w.setRequestHeader("If-None-Match", Z.etag[r])), (f.data && f.hasContent && f.contentType !== !1 || t.contentType) && w.setRequestHeader("Content-Type", f.contentType), w.setRequestHeader("Accept", f.dataTypes[0] && f.accepts[f.dataTypes[0]] ? f.accepts[f.dataTypes[0]] + ("*" !== f.dataTypes[0] ? ", " + bt + "; q=0.01" : "") : f.accepts["*"]);
	...
	Z.param = function(e, t) {
		...
		serializeArray: function() {
			return this.map(function() {
				...
				var e = this.type;
				return this.name && !Z(this).is(":disabled") && Dt.test(this.nodeName) && !Et.test(e) && (this.checked || !ke.test(e))
			}).map(function(e, t) {
				var n = Z(this).val();
	...
	e.attachEvent && e.attachEvent("onunload", function() {
	...
	}), Q.cors = !! At && "withCredentials" in At, Q.ajax = At = !! At, Z.ajaxTransport(function(e) {
		var t;
		return Q.cors || At && !e.crossDomain ? {
			send: function(n, i) {
				...
				t = function(e) {
					return function() {
						t && (delete jt[a], t = o.onload = o.onerror = null, "abort" === e ? o.abort() : "error" === e ? i(o.status, o.statusText) : i(_t[o.status] || o.status, o.statusText, "string" == typeof o.responseText ? {
							text: o.responseText
	...
	Z.ajaxSetup({
		...
		var r, o, a, s = t.jsonp !== !1 && (qt.test(t.url) ? "url" : "string" == typeof t.data && !(t.contentType || "").indexOf("application/x-www-form-urlencoded") && qt.test(t.data) && "data");
		return s || "jsonp" === t.dataTypes[0] ? (r = t.jsonpCallback = Z.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s ? t[s] = t[s].replace(qt, "$1" + r) : t.jsonp !== !1 && (t.url += (ct.test(t.url) ? "&" : "?") + t.jsonp + "=" + r), t.converters["script json"] = function() {
			return a || Z.error(r + " was not called"), a[0]
		}, t.dataTypes[0] = "json", o = e[r], e[r] = function() {
			a = arguments
		}, i.always(function() {
			e[r] = o, t[r] && (t.jsonpCallback = n.jsonpCallback, Lt.push(r)), a && Z.isFunction(o) && o(a[0]), a = o = void 0
		}), "script") : void 0
	...
	Z.offset = {
		...
		offset: function(e) {
			...
			return o ? (t = o.documentElement, Z.contains(t, i) ? (typeof i.getBoundingClientRect !== Ne && (r = i.getBoundingClientRect()), n = W(o), {
	...
	return Z.noConflict = function(t) {
		return e.$ === Z && (e.$ = $t), t && e.jQuery === Z && (e.jQuery = Mt), Z
	...
	function t(t) {
		var a = t || window.event,
			...
			h = 0,
			g = 0;
		if (t = e.event.fix(a), t.type = "mousewheel", "detail" in a && (d = -1 * a.detail), "wheelDelta" in a && (d = a.wheelDelta), "wheelDeltaY" in a && (d = a.wheelDeltaY), "wheelDeltaX" in a && (f = -1 * a.wheelDeltaX), "axis" in a && a.axis === a.HORIZONTAL_AXIS && (f = -1 * d, d = 0), l = 0 === d ? f : d, "deltaY" in a && (d = -1 * a.deltaY, l = d), "deltaX" in a && (f = a.deltaX, 0 === d && (l = -1 * f)), 0 !== d || 0 !== f) {
			if (1 === a.deltaMode) {
			...
			if (p = Math.max(Math.abs(d), Math.abs(f)), (!o || o > p) && (o = p, i(a, p) && (o /= 40)), i(a, p) && (l /= 40, f /= 40, d /= 40), l = Math[l >= 1 ? "floor" : "ceil"](l / o), f = Math[f >= 1 ? "floor" : "ceil"](f / o), d = Math[d >= 1 ? "floor" : "ceil"](d / o), c.settings.normalizeOffset && this.getBoundingClientRect) {
				var y = this.getBoundingClientRect();
				h = t.clientX - y.left, g = t.clientY - y.top
			}
			return t.deltaX = f, t.deltaY = d, t.deltaFactor = o, t.offsetX = h, t.offsetY = g, t.deltaMode = 0, s.unshift(t, l, f, d), r && clearTimeout(r), r = setTimeout(n, 200), (e.event.dispatch || e.event.handle).apply(this, s)
		}
	}
	...
	function e(e) {
		e.each(function() {
			var e = s.filter(".active"),
				t = $(this);
			t.data("link") === e.data("link") && t.addClass("active").siblings().removeClass("active")
		})
	}
	...
	function t(e) {
		var t = 0,
			i = e.data("link");
		o = i, t = 100 * -o + "%", n(), e.addClass("active").siblings().removeClass("active"), s.eq(i).addClass("active").siblings(".screen").removeClass("active"), a.css("top", t), a.on("transitionend webkitTransitionEnd oTransitionEnd", function(e) {
			"top" === e.originalEvent.propertyName && (u = !1)
		})
	}

	function n() {
		for (var e = 0; e < ce.length; e++) clearTimeout(ce[e]);
		ce = [];
		var t = s.filter(".active"),
			n = t.find(".trigger");
		n.removeClass("trigger")
	}

	function i() {
		ue.get(0).paused || ue.get(0).pause(), ue.get(0).muted || (ue.get(0).muted = !0), se.hasClass("active") && se.removeClass("active"), l.hasClass("pagination__item_theme_light") && l.removeClass("pagination__item_theme_light"), g.hasClass("active") && (r(I, 0), r(B, 0), r(ee, 200), r(X, 0), r(z, 0), r(te, 500), r(re, 200), r(oe, 100), r(ae, 0), r(ie, 300), ne.each(function() {
			var e = $(this);
			r(e, 200)
		}), T.each(function() {
			var e = $(this);
			...
			var e = $(this);
			r(e, 1e3)
		}), r(F, 0), r(Q, 1300), r(J, 2200), r(K, 2e3), r(Z, 0)), m.hasClass("active") && (k.each(function() {
			var e = $(this);
			r(e, 100)
		}), L.each(function() {
			var e = $(this);
			r(e, 1e3)
		})), v.hasClass("active") && (N.each(function() {
			var e = $(this);
			r(e, 100)
		}), q.each(function() {
			var e = $(this);
			r(e, 500)
		})), y.hasClass("active") && (E.each(function() {
			var e = $(this);
			r(e, 100)
		}), H.each(function() {
			var e = $(this);
			r(e, 1e3)
		})), x.hasClass("active") && (l.addClass("pagination__item_theme_light"), setTimeout(function() {
			ue.get(0).currentTime = 0, ue.get(0).play()
		}, 500), D.each(function() {
			var e = $(this);
			r(e, 100)
		}), O.each(function() {
			var e = $(this);
			r(e, 1e3)
		})), b.hasClass("active") && (S.each(function() {
			var e = $(this);
			r(e, 100)
		}), P.each(function() {
			var e = $(this);
			r(e, 300)
		})), w.hasClass("active") && (j.each(function() {
			var e = $(this);
			r(e, 100)
		}), R.each(function() {
			var e = $(this);
			r(e, 400)
		})), C.hasClass("active") && (_.each(function() {
			var e = $(this);
			r(e, 100)
		}), r(W, 3e3), M.each(function() {
			var e = $(this);
			r(e, 1e3)
		})), fe = 1e3
	}
	...
	var o = 0,
		...
		d = f.find(".close-btn"),
		p = $(".menu__item"),
		h = p.find(".menu__item-link"),
		g = s.filter(".screen_first"),
		m = s.filter(".screen_second"),
		v = s.filter(".screen_third"),
		y = s.filter(".screen_fourth"),
		x = s.filter(".screen_fifth"),
		b = s.filter(".screen_sixth"),
		w = s.filter(".screen_seventh"),
		C = s.filter(".screen_eighth"),
		T = g.find(".animate-text"),
		k = m.find(".animate-text"),
		N = v.find(".animate-text"),
		E = y.find(".animate-text"),
		D = x.find(".animate-text"),
		S = b.find(".animate-text"),
		j = w.find(".animate-text"),
		_ = C.find(".animate-text"),
		A = g.find(".animation__opacity"),
		L = m.find(".animation__opacity"),
		q = v.find(".animation__opacity"),
		H = y.find(".animation__opacity"),
		O = x.find(".animation__opacity"),
		M = C.find(".animation__opacity"),
		F = g.find(".flag"),
		P = b.find(".features__image"),
		R = w.find(".list__item"),
		W = C.find("#animation__superhero"),
		I = g.find("#screen__mask-1"),
		B = g.find("#screen__mask-2"),
		X = g.find("#screen__mask-3"),
		z = g.find("#screen__mask-4"),
		Y = g.find("#animation__mask_cyclist-1"),
		U = g.find("#animation__mask_cyclist-2"),
		V = g.find("#animation__mask_cyclist-3"),
		G = g.find("#animation__mask_cyclist-4"),
		Q = Y.find(".animation__cyclist"),
		J = U.find(".animation__cyclist"),
		K = V.find(".animation__cyclist"),
		Z = G.find(".animation__cyclist"),
		ee = g.find("#animation__main"),
		te = g.find("#animation__ballon"),
		ne = g.find(".animation__rise"),
		ie = g.find("#animation__surfer"),
		re = g.find("#animation__cloud-left"),
		oe = g.find("#animation__cloud-right1"),
		ae = g.find("#animation__cloud-right2"),
		se = x.find("#sec5-video-bg"),
		ue = se.find(".screen__video"),
		le = x.find(".player"),
		ce = [],
		fe = 0;
	s.first().addClass("active"), l.first().addClass("active"), p.first().addClass("active"), i(), ue.get(0).pause(), le.on("click", function(e) {
		e.preventDefault();
		var t = $(event.target);
		console.log(t), (t.is(".player__start-btn") || t.is(".player__desc")) && (ue.get(0).currentTime = 0, ue.get(0).muted = !1, se.addClass("active"))
	}), F.on("click", function(t) {
		t.preventDefault(), u = !0, o = F.data("link"), e(p), e(l);
		var r = 100 * -o + "%";
		a.css("top", r), a.on("transitionend webkitTransitionEnd oTransitionEnd", function() {
			u = !1
		}), n(), x.addClass("active").siblings(".screen").removeClass("active"), e(p), e(l), i()
	}), c.on("click", function(e) {
		e.preventDefault(), c.addClass("hamburger-menu_hidden"), f.addClass("active")
	}), d.on("click", function(e) {
		e.preventDefault(), c.removeClass("hamburger-menu_hidden"), f.removeClass("active")
	}), l.on("click", function(r) {
		r.preventDefault(), u = !0, n(), t($(this)), e(p), i()
	}), h.on("click", function(r) {
		r.preventDefault(), u = !0;
		var o = $(this),
			a = o.parent();
		n(), t(a), e(l), i()
	}), $(window).on("DOMMouseScroll mousewheel wheel keydown", function(t, r) {
		var c = s.filter(".active");
		u || (t.deltaY > 0 || 38 === t.which ? c.prev(".screen").length && (u = !0, o--, n(), c.prev(".screen").addClass("active").siblings(".screen").removeClass("active"), i(), e(p), e(l)) : (t.deltaY < 0 || 40 === t.which) && c.next(".screen").length && (u = !0, o++, n(), c.next(".screen").addClass("active").siblings(".screen").removeClass("active"), i(), e(p), e(l)));
		var f = 100 * -o + "%";
		a.css("top", f), a.on("transitionend webkitTransitionEnd oTransitionEnd", function(e) {
			"top" === e.originalEvent.propertyName && (u = !1)
		})
...
$(document).ready(function(){
	$('.popup-trigger').on('click', function(){
		$('.popup-trigger-inner').toggleClass('trigger-active');
	});
	$('.login').on('click', function(){
		$('.popup-login .popup').addClass('active-popup');
	});
	...
	$('body').on('click', function(e) {
		...
		if (!$('.screen_first .popup, .login').is(target) && $(target).parents('.popup').length < 1 && !$(target).hasClass('registration')) {
			...
			$('button.registration').fadeIn();
		}
	});

	$('.registration').on('click', function(){
		$('.popup-registration .popup').addClass('active-popup');
	});

	$('.screen_eighth .registration').on('click', function(){
		$('.popup-registration .popup').addClass('active-popup');
		$('button.registration').fadeOut();
	});


	//$('.player__start-btn').on('click', function(){
	...
	$('.screen__video').bind('pause', function () {
		$('.screen__video-wrapper').removeClass('active');
